...
export function detectCurrency(priceString){
  ...
  if(priceString.includes("د.م") || priceString.includes("MAD")) return "MAD";
  if(priceString.includes("SAR") || priceString.includes("ر.س")) return "SAR";
  if(priceString.includes("EGP") || priceString.includes("ج.م")) return "EGP";
